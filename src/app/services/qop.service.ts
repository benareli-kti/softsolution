...
export class QopService {
  ...
  createUpdate(product: any, partner: any, warehouse: any, qty: any): Observable<any> {
    return this.http.post(`${baseUrl}/cu?product=${product}&warehouse=${warehouse}&partner={partner}&qty={qty}`);
  }
}